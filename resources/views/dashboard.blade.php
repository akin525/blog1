                    ...
                    <div class="row">
                        <div class="col-12 col-xl-7">
                            ...
                            <p class="text-dark my-10 font-size-16">
                                We help you promote <strong class="text-warning">Blogger Support</strong> Admin Dashboard
                            </p>
                            <p class="text-dark my-10 font-size-16">
            ...
            <div class="col-12 col-xl-6">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Recent Blog Post</h4>
                        ...
                        <div class="d-flex align-items-center mb-30 gap-items-3 justify-content-between">
                            <div class="d-flex align-items-center font-weight-500">
                                <div class="mr-15 w-50 d-table">
                                    <img src="{{url($po['image'])}}" class="avatar avatar-lg rounded10 bg-primary-light" alt="">
                                </div>
                                <div>
                                    <a href="#" class="text-dark hover-primary mb-5 d-block font-size-16">{{$po['topic']}}</a>
    ...
    <div class="col-12 col-xl-4">
        <div class="box">
            <div class="box-header bg-success">
                <h4 class="box-title text-white">Quick Action</h4>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="bg-lightest px-30 py-40 rounded20 mb-20">
                            ...
                            <a href="{{route('allpost')}}" class="font-weight-500 font-size-18">
                               All Post
                            </a>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="bg-lightest px-30 py-40 rounded20 mb-20">
                            ...
                            <a href="{{route('allcategory')}}" class="font-weight-500 font-size-18">
                                All Categories
                            </a>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="bg-lightest px-30 py-40 rounded20 mb-20">
                            ...
                            <a href="{{route('add-post')}}" class="font-weight-500 font-size-18">
                                Add Post
                            </a>
                        </div>
                    </div>
